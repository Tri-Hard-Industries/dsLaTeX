...
<head>
  ...
  <title>CHTML output using MathJax-Bboldx fonts</title>
  <script>
  MathJax = {
    loader: {
      load: ['[tex]/bboldx'],
      paths: {
        ...
        'mathjax-modern': '../../mathjax-modern',
        'mathjax-bboldx-extension': '..'
      }
    },
    tex: {
      inlineMath: [['$', '$'], ['\\(', '\\)']],
  ...
  <script id="MathJax-script" async src="../../mathjax-modern/tex-mml-chtml-mathjax-modern.js"></script>
  <script>
    function convert() {
      //
...
<h1>CHTML with MathJax-Bboldx fonts</h1>
