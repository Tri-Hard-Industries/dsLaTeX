...
<head>
  ...
  <title>SVG output using MathJax-Dsfont fonts</title>
  <script>
  MathJax = {
    loader: {
      load: ['[tex]/dsfont'],
  ...
  <script id="MathJax-script" async src="../../mathjax-modern/tex-mml-svg-mathjax-modern.js"></script>
  <script>
    function convert() {
      //
...
<h1>SVG with MathJax-Dsfont fonts</h1>
